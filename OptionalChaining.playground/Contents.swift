...
if let roomCount = john.residence {
    print("John's residence has \(roomCount.numberOfRooms) room(s).")
} else {
    print("Unable to retreive the number of rooms")
}
...
if let firstRoomName = john2.residence?[0].name {
    ...
    print("Unable to retreive the first room name.")
}
...
if let johnStreet = john2.residence?.address?.street {
    ...
    print("Unable to retreive the address")
}
...
if let johnsStreet = john2.residence?.address?.street {
    ...
    print("Unable to retreive the addreess.")
}
