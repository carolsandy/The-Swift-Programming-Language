...
struct Dog: PrettyTextRepresentable {
    var name: String
    var textualDescription: String {
        return "I am a pretty dog called: \(name)"
    }
}

let kiwiDog = Dog(name: "Kiwi")
print(kiwiDog.prettyTextualDescription)
...
let strings = ["Carmen", "Kiwi", "Ray"]

print(equalNumbers.allEqual())
print(differentNumbers.allEqual())
print(strings.allEqual())
